...
-- ══════════════════════════════════════════
-- CREATE DATABASE MiniStore -- Se comenta para que no de error al volver a ejecutarse
USE MiniStore; -- Equivalente en PostgreSQL: no requiere USE, se selecciona la base al conectar
